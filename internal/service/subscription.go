...
func (s *Service) GetUsersSubscription(ctx context.Context, userID uuid.UUID) ([]entity.Subscription, error) {
...
func (s *Service) GetUsersIDsForSegment(ctx context.Context, segmentID uuid.UUID) ([]uuid.UUID, error) {
